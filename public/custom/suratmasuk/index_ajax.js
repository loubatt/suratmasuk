...
function tableObject(){
    ...
    var menuHandler = {
        ...
        */
        ...
        "MenuSearch"    : {
            "Template" : function(){
                return "<button class='btn btn-primary btn-md btn-MenuSearch'><span class='glyphicon glyphicon-search'></span></button> "
            },
            "Create" : function(){
                this.Remove()
                var btnMenuSearch = menuArea.append(this.Template)
                $(".btn-MenuSearch").click(function(){
                    searchModalHandler.Show()
                })
            },
            "Remove" : function(){
                $(".btn-MenuSearch").remove()
            }                     
        }
    }
